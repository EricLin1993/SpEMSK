function result = imxshow(in1,fig,parm1)
...
%
% Modified by Onur Afacan June 10th 2016
% Modified by Fatih Calakli April 26th 2022
if nargin < 3
  parm1 = [];
end
...
if ~ischar(in1)
  ...
  % changed fig = [] to fig = get(figure,'Number') - FC
  if ( nargin < 2 ); fig = get(figure,'Number'); end
